...
from evacode.teams.backend_detect import BackendDetectionError, detect_backend
from evacode.teams.mailbox import Mailbox, create_message
...
from evacode.teams.progress import TeammateProgress
from evacode.teams.registry import AgentNameRegistry
from evacode.teams.shared_task import SharedTaskStore
from evacode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from evacode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
