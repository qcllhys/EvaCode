...
from evacode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from evacode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".evacode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".evacode", "memory")
    ...
    async def _do_consolidation(
        ...
        from evacode.tools.bash import BashTool
        from evacode.tools.edit_file import EditFileTool
        from evacode.tools.glob import GlobTool
        from evacode.tools.grep import GrepTool
        from evacode.tools.read_file import ReadFileTool
        from evacode.tools.write_file import WriteFileTool

        transcript_dir = os.path.join(self._work_dir, ".evacode", "sessions")
