...
def build_teammate_tools(
    ...
    from evacode.tools.send_message import SendMessageTool
    from evacode.tools.task_create import TaskCreateTool
    from evacode.tools.task_get import TaskGetTool
    from evacode.tools.task_list import TaskListTool
    from evacode.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from evacode.tools.agent_tool import FORK_QUERY_SOURCE
