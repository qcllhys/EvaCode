...
PROJECT_AGENTS_DIR = ".evacode/agents"
USER_AGENTS_DIR = "~/.evacode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("evacode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from evacode.agents.parser import parse_frontmatter, _validate_agent_meta
