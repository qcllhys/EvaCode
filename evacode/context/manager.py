...
from evacode.serialization import build_messages
...
SESSION_SUBDIR = ".evacode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from evacode.tools.base import StreamEnd, StreamEvent, TextDelta
