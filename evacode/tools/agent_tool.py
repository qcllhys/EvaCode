...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from evacode.agents.fork import ForkError, build_forked_messages
        from evacode.agents.parser import AgentDef
        from evacode.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from evacode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from evacode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from evacode.agents.fork import ForkError, build_forked_messages
        from evacode.agents.parser import AgentDef
        from evacode.agents.tool_filter import build_teammate_tools
        from evacode.agent import Agent as AgentClass
        from evacode.conversation import ConversationManager
        from evacode.permissions import (
            DangerousCommandDetector,
        ...
        from evacode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from evacode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from evacode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from evacode.worktree.integration import (
