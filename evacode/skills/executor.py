...
from evacode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from evacode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from evacode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
